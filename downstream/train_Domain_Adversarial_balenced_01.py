...
def train_DANN(cfg: DictConfig):
    ...
    for epoch in range(total_epochs):
        ...
        train_loss, train_emo_loss, train_domain_loss = train_one_epoch(
            model,
            optimizer,
            criterion,
            real_loader,
            syn_loader,
            full_dataset.collator,  #传 collator
            epoch,
            total_epochs,
            max_alpha=cfg.optimization.max_alpha,
            device=device,
        ...
        logger.info(
            ...
            f"emo loss {train_emo_loss/len(real_loader):.4f} | "
            f"domain loss {train_domain_loss/len(real_loader):.4f} | "
