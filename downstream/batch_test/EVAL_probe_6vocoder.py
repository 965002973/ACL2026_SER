...
HEAD_CKPT = "/data/zhaohaishu/Codes/emotion2vec-main/downstream/outputs/2025-12-30/probe_train_human_6vocoder/model_best.pth"
...
def parse_item(item):
    ...
    emo = item["data_source"].lower().strip()
    if emo not in MAP:
