...
HEAD_CKPT = "/data/zhaohaishu/Codes/emotion2vec-main/downstream/outputs/2025-12-31/10-17-09/model_best.pth" # training outputs
TARGET_SR = 16000
GRANULARITY = "frame"  # same as training: "frame"/"utterance"
...
def main():
    ...
    for wav_path, gt_id in pairs:
        ...
        feats = extract_feats(wav_path, emo2vec, task, granularity=GRANULARITY)  # (T,768)
        ...
        wa, ua, f1, per_class = compute_metrics(
